...
${mainImage === img ? "border-black" : "border-gray-200"}`}
              ...
              <div className="flex-1">
                <img
                  src={mainImage}
                  alt="Product"
                  className="w-full h-[420px] object-cover rounded transition-transform duration-500 hover:scale-105"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <span className="line-through text-gray-400">₹3,999</span>
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button className="p-3  rounded-lg hover:text-red-500">
                  <Heart />
                </button>
              </div>
            </div>
